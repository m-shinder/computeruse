...
WARNING_TEXT = "⚠️ Security Alert: Never provide access to sensitive accounts or data, as malicious web content can hijack LLM's behavior"
...
async def main():
    ...
    st.title("LLM Computer Use Demo")
